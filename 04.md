...
## B
8. Escribir un programa que usando la función sumar que recibe una lista y devuelva la suma de sus elementos. Imprimir el resultado para [1, 2, 3]. Usar recursividad. No usar función sum

9. Escribir un programa que usando la función longitud que recibe una lista y devuelva la cantidad de sus elementos. Imprimir el resultado para [1, 2, 3]. Usar recursividad. No usar función length ni sum

10. Escribir un programa que defina la(s) siguiente(s) funcion(es):
...
11. Escribir un programa que defina las siguientes funciones:
...
12. Escribir un programa que defina la(s) siguiente(s) funcion(es):
...
13. Tomando en cuenta el ejercicio anterior, invertir la pirámide.
- P.e. si h = 3, resultado = 
"* * *
* *
*"

14. Escribir un programa que solicite "Ingresar número de veces" que son las veces que se deberá ingresar algún número. Usar recursividad. 
- Imprimir el resultado de concatenar "El número ingresado es: N" donde N es ingresado por teclado en cada vez
- 

15. Escribir un programa que permita adivinar un número.
